...
<div class="flex flex-col md:flex-row">
    ...
    <div class="flex-1 p-4">
        <h1 class="text-2xl font-bold mb-6 fade-in">User Management</h1>
        ...
        <div class="glass p-6 rounded-lg mb-6 fade-in">
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex items-center">
                    ...
                    <select id="filter-admin" class="bg-white/10 border border-white/20 text-white text-sm rounded-lg focus:ring-accent focus:border-accent block p-2.5">
                ...
                <table class="w-full text-sm text-left">
                    ...
                    <tbody id="users-table-body">
                        <?php foreach ($users as $user): ?>
                            <tr class="border-b border-white/10 hover:bg-white/5" data-is-admin="<?php echo $user['is_admin']; ?>">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function filterUsers() {
            ...
            userRows.forEach(row => {
                ...
                let showRow = (username.includes(searchTerm) || email.includes(searchTerm) || location.includes(searchTerm));
                
                if (adminFilter === 'admin' && !isAdmin) {
                    showRow = false;
                } else if (adminFilter === 'regular' && isAdmin) {
                    showRow = false;
                }
        ...
        filterAdmin.addEventListener('change', filterUsers);
